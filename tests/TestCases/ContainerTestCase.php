...
abstract class ContainerTestCase extends TestCase
{
	...
	protected function mockConfig(array $options = array())
	{
		...
		$options = array_merge($defaults, array(
			...
			'TwitterBootstrap5.icon.prefix'       => 'fa',
			'TwitterBootstrap5.icon.set'          => 'fa',
			'TwitterBootstrap5.icon.tag'          => 'i',
			'TwitterBootstrap5.labelWidths'       => array('large' => 2, 'small' => 4),
			'TwitterBootstrap5.viewports'         => array(
				'large'  => 'lg',
				'medium' => 'md',
				'small'  => 'sm',
				'mini'   => 'xs',
